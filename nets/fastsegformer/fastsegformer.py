...
class FastSegFormer(nn.Module):
    def __init__(self, num_classes=21, pretrained=False, Pyramid="pooling", fork_feat=False, cnn_branch=False):
    ...
    def forward(self, x):
        ...
        feat1, feat2, feat3, x = self.backbone(x)
        """
    ...
    def get_Flops_params(self, model, input):
        
        flops, params = profile(model, (input,))
        
        print("GFLOPs=", str(flops/1e9))
